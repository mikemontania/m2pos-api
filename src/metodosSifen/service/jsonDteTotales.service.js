const { defaultConfig } = require("./config");
  const generateDatosTotales =(  data, items )=> {
    ...
    if (agregarDSub) {
      ...
      if (data['tipoImpuesto'] == 1 || data['tipoImpuesto'] == 5) {
        ...
        if (dSub5 > 0) {
          ...
          if (data.moneda !== 'PYG') {
            jsonResult['dSub5'] = parseFloat(dSub5.toFixed(defaultConfig.taxDecimals));
          } else {
            jsonResult['dSub5'] = parseFloat(dSub5.toFixed(defaultConfig.pygTaxDecimals));
          }
        } else {
          jsonResult['dSub5'] = 0;
        }
        ...
        if (dSub10 > 0) {
          ...
          if (data.moneda !== 'PYG') {
            ...
            jsonResult['dSub10'] = parseFloat(dSub10.toFixed(defaultConfig.taxDecimals));
          } else {
            jsonResult['dSub10'] = parseFloat(dSub10.toFixed(defaultConfig.pygTaxDecimals));
          }
        } else {
          jsonResult['dSub10'] = 0;
        }
    ...
    if (data.moneda !== 'PYG') {
      ...
      dLiqTotIVA10 = parseFloat(dLiqTotIVA10.toFixed(defaultConfig.pygTaxDecimals));
    }
    ...
    if (agregarDSub) {
      if (data.tipoImpuesto == 1 || data.tipoImpuesto == 5) {
        ...
        if (dIVA5 > 0 || dIVA10 > 0 || dLiqTotIVA5 > 0 || dLiqTotIVA10 > 0 || comisionLiquid > 0) {
          ...
          //Redondeo
          if (data.moneda !== 'PYG') {
            jsonResult['dTotIVA'] = parseFloat(jsonResult['dTotIVA'].toFixed(defaultConfig.taxDecimals));
          } else {
            jsonResult['dTotIVA'] = parseFloat(jsonResult['dTotIVA'].toFixed(defaultConfig.pygTaxDecimals));
          }
        } else {
        ...
        if (dBaseGrav5 > 0) {
          //Redondeo
          if (data.moneda !== 'PYG') {
            dBaseGrav5 = parseFloat(dBaseGrav5.toFixed(defaultConfig.taxDecimals));
          } else {
            dBaseGrav5 = parseFloat(dBaseGrav5.toFixed(defaultConfig.pygTaxDecimals));
          }
        ...
        if (dBaseGrav10 > 0) {
          //Redondeo
          if (data.moneda !== 'PYG') {
            dBaseGrav10 = parseFloat(dBaseGrav10.toFixed(defaultConfig.taxDecimals));
          } else {
            dBaseGrav10 = parseFloat(dBaseGrav10.toFixed(defaultConfig.pygTaxDecimals));
          }
    ...
    if (moneda != 'PYG') {
      ...
      if (data['condicionTipoCambio'] == 1) {
        //Por el Global
        jsonResult['dTotalGs'] = parseFloat((dTotGralOpe * data['cambio']).toFixed(defaultConfig.pygDecimals));
      } else {
  ...
  module.exports = {
    redondeoSedeco,generateDatosTotales
  };
