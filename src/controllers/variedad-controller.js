...
const getById = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({ error: 'Error al buscar la variedad por ID' });
  }
};
...
const findAll = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({ error: 'Error al buscar variedades' });
  }
};
...
const disable = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({ error: 'Error al desactivar la variedad' });
  }
};
